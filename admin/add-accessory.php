...
if (strlen($_SESSION['aid'])==0) {
    ...
    if(isset($_POST['add'])) {
        ...
        $image=$_FILES["image"]["name"];
            ...
            $query=mysqli_query($con, "insert into accessory(image,name,description,price) value('$image','$product_name','$product_desc','$product_price')");
...
<head>
    ...
    <title>Add Accessories Page</title>
    <!--
        ...
        <div class="row tm-mt-big">
            ...
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12" style="margin-bottom:50px;">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">Add Accessory</h2>
                        </div>
                    </div>
                        ...
                        <form method="post" class="d-flex col-12 tm-edit-product-form" enctype="multipart/form-data">
                            <div class="col-xl-7 col-lg-7 col-md-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="price" name="price" type="number" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="image" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Product Image</label>
                                    <input id="image" name="image" type="file" class="form-control col-xl-9 col-lg-8 col-md-8 col-sm-7" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                                        <button type="submit" class="btn btn-primary" name="add">Add Accessory
                                        </button>
                                    </div>
                                </div>
                            </div>
